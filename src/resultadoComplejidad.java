 ...
 * @author sarai
 */
public class resultadoComplejidad extends javax.swing.JFrame {

    /**
     * Creates new form resultadoComplejidad
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tiempo calculados y guardados en un Excel");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultadoComplejidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resultadoComplejidad().setVisible(true);
            }
        });
    }
